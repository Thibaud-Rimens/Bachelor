...
use crate::structures::{ExchangeTimeAdministration};
use crate::utils::{parse_i16, parse_option_i32, parse_string};
...
impl FileParser for  ExchangeTimeAdministrationParser {
    type Output =  ExchangeTimeAdministration;
